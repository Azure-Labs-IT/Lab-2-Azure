...
<p align="center">
Login to Azure(no need if you're already logged in) and on the top search bar search for Virtual Machines. Once it appears in the drop-down options of the search bar click on it: <br/>
...
<b>(If you are running your account on a free trial please keep in mind that some options/specifications for your virtual machine are only available for paid/paying users) <br/>
...
Assign your Virtual Machine to a Resoruce Group:  <br/>
